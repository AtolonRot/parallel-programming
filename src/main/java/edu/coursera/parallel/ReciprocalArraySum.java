package edu.coursera.parallel;//package edu.coursera.parallel;
...
public final class ReciprocalArraySum {
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        ...
        protected void compute() {
            final int COMPUTE_THRESHOLD = 500000;
            if (endIndexExclusive - startIndexInclusive <= COMPUTE_THRESHOLD) {
    ...
    protected static double parManyTaskArraySum(final double[] input,
        ...
        ReciprocalArraySumTask rec1 = new ReciprocalArraySumTask(0, input.length, input);
        pool.invoke(rec1);
